...
export default function ProjectDetailPage() {
  ...
  return (
    data && (
      <div className="pt-[100px] pb-[80px] min-h-dvh flex flex-col justify-center items-center">
        <div className="flex-1 container mx-auto grid grid-cols-2 gap-4 items-center">
